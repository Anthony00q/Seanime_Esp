                            ...
                            <AccordionItem value="more">
                                ...
                                <AccordionContent className="space-y-4">
                                    ...
                                    <Field.Switch
                                        ...
                                        help={t("settings.torrentstream.slowSeedingHelp")}
                                        moreHelp={t("settings.torrentstream.slowSeedingMoreHelp")}
                                    />

                                    <Field.Switch
                                        side="right"
                                        name="disableAcceleratedStartup"
                                        label={t("settings.torrentstream.disableAcceleratedStartup")}
                                        disabled={f.watch("slowSeeding")}
                                        moreHelp={t("settings.torrentstream.disableAcceleratedStartupMoreHelp")}
                                    />
                                </AccordionContent>
                            </AccordionItem>
                        </Accordion>
