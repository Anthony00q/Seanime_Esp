                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        <Field.Select
                                            ...
                                            options={[
                                                "en-US", "en-GB", "es", "fr", "de", "it", "pt-BR", "pt-PT",
                                                "ru", "ja", "ko", "zh-hans", "zh-hant", "ar", "tr",
                                                "pl", "nl", "sv", "nb", "da", "fi", "el", "cs", "hu",
                                                "ro", "id", "uk", "bg", "sk", "sl", "et", "lv", "lt",
                                                "hi", "bn", "ta", "te", "mr", "kn", "ml", "pa",
                                                "fa", "ur", "sw", "af", "ms", "hr", "sr", "he", "th", "vi",
                                            ].map(code => ({ value: code, label: t(`videoPlayer.translationLanguages.${code}`) || code }))}
                                            contentClass="z-[999]"
