                            ...
                            <>
                                ...
                                >
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <h4 className="font-semibold">{t("gettingStarted.player.mpvConfig")}</h4>
                                    </div>
                                    <Field.Text
                                        name="mpvSocket"
                                        label={t("gettingStarted.player.socketPath")}
                                        help={t("gettingStarted.player.mpvSocketHelp")}
                                    />
                                </motion.div>
                            </>
                        )}
                        ...
                        {defaultPlayer === "iina" && (
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    ...
                                    <h4 className="font-semibold">{t("gettingStarted.player.iinaConfig")}</h4>
                                </div>
                                <Field.Text
                                    name="iinaSocket"
                                    label={t("gettingStarted.player.socketPath")}
                                    help={t("gettingStarted.player.iinaSocketHelp")}
                                />
